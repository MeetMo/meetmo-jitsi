/* global $, APP, Vimeo, interfaceConfig, onVimeoPlayerReady, onVimeoPlayerStateChange,
onVimeoPlayerError, onVolumeChange, onVideoProgress */
...
export default class SharedVimeoVideoManager {
    ...
    onSharedVideoStart(id, url, attributes) {
         ...
         * @param event
         */
        window.onVideoProgress = function() {
        ...
        window.onVimeoPlayerReady = function() {
    ...
    onSharedVideoStop(id, attributes) {
        ...
        VideoLayout.showLargeVideoContainer(SHARED_VIDEO_CONTAINER_TYPE, false)
            .then(() => {
                ...
                const _iframeIdDiv = document.createElement('div');
