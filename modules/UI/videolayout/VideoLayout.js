...
import SharedVimeoVideoThumb from '../shared_video/SharedVimeoVideoThumb';
...
const VideoLayout = {
    ...
    addRemoteParticipantContainer(participant) {
        if (!participant || participant.local) {
            ...
            console.log('add the remote participant =>>>>', participant);
            
            const sharedVideoThumb = participant.name === 'Vimeo' ? new SharedVimeoVideoThumb(
                participant,
                SHARED_VIDEO_CONTAINER_TYPE,
                VideoLayout) :
                new SharedVideoThumb(
                    participant,
                    SHARED_VIDEO_CONTAINER_TYPE,
                    VideoLayout)
                ;
