...
/**
 * Subscribes to changes to the custom layout for the conference.
 */
StateListenerRegistry.register(
    /* selector */ state => state['features/letxsoft'].layout,
    /* listener */ _sendFollowMeCommand);

/**
 * Subscribes to changes to the custom background for the conference.
 */
StateListenerRegistry.register(
    /* selector */ state => state['features/letxsoft'].background,
    /* listener */ _sendFollowMeCommand);
...
function _getFollowMeState(state) {
    ...
    return {
        ...
        currentLayout: state['features/letxsoft'].layout,
        currentBackground: state['features/letxsoft'].background
    };
}
