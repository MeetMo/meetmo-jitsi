 ...
 * }
 */
export const SET_SHARED_VIMEO_VIDEO_STATUS = 'SET_SHARED_VIMEO_VIDEO_STATUS';
...
/**
 * The type of the action which signals to start the flow for starting or
 * stopping a shared Vimeo video.
 *
 * {
 *     type: TOGGLE_SHARED_VIMEO_VIDEO
 * }
 */
export const TOGGLE_SHARED_VIMEO_VIDEO = 'TOGGLE_SHARED_VIMEO_VIDEO';
